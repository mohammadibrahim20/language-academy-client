...
const SubBanner = ({title, subTitle}) => {
  return (
    <div className="h-[400px] bg-cover bg-center py-4 px-8 text-center flex justify-center items-center">
      <img
        src={Banner}
        alt="Banner Image"
        className="w-full h-[412px] "
      />
       <div className="absolute bg-black bg-opacity-10 flex flex-col justify-center h-[400px] w-full my-5  p-4">
